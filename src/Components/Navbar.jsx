    ...
    return (
      <nav className="navbar navbar-expand-lg navbar-dark bg-tnits-dark sticky-top">
        <div className="container-fluid">
          <button
            className="btn text-white d-lg-none me-2"
            type="button"
          ...
          <Link className="navbar-brand d-flex align-items-center" to="/">
            <img src={logo} alt="TNITS Logo" className="img-fluid me-2" style={{maxHeight: "40px"}} />
          ...
          <div className="d-flex align-items-center ms-auto">
            ...
            <div className="d-flex align-items-center">
              <span className="text-white me-2 d-none d-sm-inline">ADMIN</span>
              <div
